...
var MnI18nServices = (function () {
    ...
    // setConfig(config: I18nConfig) {
    MnI18nServices.prototype.setConfig = 
    // setConfig(config: I18nConfig) {
    function (config) {
        var _this = this;
        var option = {
    ...
    /**
         ...
         * @return {string}
         */
    MnI18nServices.prototype.getText = /**
         * 获得国际化结果
         * @param cb
         * @param key
         * @param params
    ...
    /**
         ...
         * @return {string}
         */
    MnI18nServices.prototype.translateText = /**
         * translate text
         * @param res
         * @param key
         * @param params
    ...
    /**
         ...
         * @param params
         */
    MnI18nServices.prototype.byText = /**
         * 根据当前本地值，获取国际化结果
         * @param {string} key
         * @param params
         */
