...
var MnEchartsServices = (function () {
    ...
    // 外部配置匹配颜色
    // 外部配置匹配颜色
    MnEchartsServices.prototype.setColorsMap = 
    // 外部配置匹配颜色
    function (colors_map) {
    ...
    /**
         ...
         * @return {any}
         */
    MnEchartsServices.prototype.pick = /**
         *
         * @param arr
         * @param key
         * @return {any}
    ...
    /**
         ...
         * @return {number}
         */
    MnEchartsServices.prototype.total = /**
         * 计算数组中某项的的总数
         * @param arr
         * @param key
         * @return {number}
    ...
    MnEchartsServices.prototype.getEchartResult = function (type, data, setting, $charts, $mycharts) {
        ...
        fn.$legend = function () {
            ...
            mu.run(setting.sort && !setting.sort_all, function () {
                var selected = mu.map(_legend, function (l) {
                    return ({
                        __key__: l,
                        __val__: false
                    });
    ...
    /**
         ...
         * @return {any[]}
         */
    MnEchartsServices.prototype.convert = /**
         * 数据根据规则转换
         * @param data
         * @param convert
         * @return {any[]}
    ...
    /**
         ...
         * @return {any[]}
         */
    MnEchartsServices.prototype.transpose = /**
         * 顺时针旋转90°多维数组
         * @param {any[]} arr
         * @return {any[]}
         */
    ...
    /**
         ...
         * @param options
         */
    MnEchartsServices.prototype.adjustOptionsWithColors = /**
         * 调整 echart 颜色 以及 legend 的样式
         * @param options
         */
    function (options) {
    ...
    /**
         ...
         * 调整legend的个数对图表主体位置的影响
         */
    MnEchartsServices.prototype.adjustOptionsWithLegend = /**
         * 调整legend显示/隐藏图表主体位置
         * 调整legend的个数对图表主体位置的影响
         */
