...
MnEchartsPanelComponent.decorators = [
    { type: core_1.Component, args: [{
                ...
                styles: [':host {  display: block;  width: 100%;}:host mn-panel-body {  padding: 0;}:host req-http {  padding: 16px;}:host .mn-dataView {  position: absolute;  top: 0;  right: 0;  bottom: 0;  left: 0;  background: #fff;  z-index: 999;  padding: 16px;  overflow: auto;}:host nz-dropdown a {  color: inherit;}:host mn-panel-toolbar.toggle {  display: none;}:host:hover mn-panel-toolbar.toggle {  display: block;}:host [mn-echarts-render] {  height: 100%;}:host(mn-echarts-box) {  height: 100%;}:host(mn-echarts-box) mn-panel {  height: 100%;}:host(mn-echarts-box) mn-panel-header {  position: absolute;  width: 100%;  visibility: visible;  z-index: 200;  border-bottom: 1px transparent solid;  pointer-events: none;}:host(mn-echarts-box) mn-panel-header mn-panel-toolbar {  pointer-events: auto;}'],
